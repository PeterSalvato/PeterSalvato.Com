...
{% include specimen.html type="image" image="/assets/img/readings/ableton/logo.png" label="The mark" location="Site-wide" observation="Three bars and three lines. Abstract, geometric, no wordmark. It says almost nothing, which turns out to be a choice that runs through everything." %}
...
{% include specimen.html type="image" image="/assets/img/readings/ableton/push-carousel.png" label="Six identities" location="Push product page" observation="Push is six things at once. Instead of picking one identity and hedging, the page gives you all six in sequence. Then six artists with completely different setups. The purchase decision happened three scrolls before the buy button." %}

...
analysis: |
  Supreme's website is the purest brand expression I've read. Not because it's well-designed in any conventional sense. Because it does exactly one thing and it does it with total commitment. The site is scarce because the brand is scarce. The emptiness is the [voice](/practice/voice-governance/).
  ...
  In an era where AI tools make it trivially easy to generate content, Supreme's refusal to have content at all is the most radical [practitioner stance](/practice/practitioner-in-the-loop/) in branding. The human decision here isn't what to say. It's the discipline to say nothing.
---

{% include specimen.html type="image" image="/assets/img/readings/supreme/logo.png" label="The mark" location="Homepage" observation="Red box, white Futura Bold Italic. The most recognized brand mark in streetwear. The mark doesn't describe what Supreme sells. It doesn't need to." %}

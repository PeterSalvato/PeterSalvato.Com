...
I work across design, engineering, and AI governance. The problems I take on usually live in the gaps between them: the design system that engineering can't maintain, the AI output that lost the voice, the workflow that runs but fails silently.

...
icon: cases
status: "Deployed"
context: "A Windows Forms desktop application serving executive search firms on six continents. I saw that the delivery layer was about to become the constraint, made the case for the browser over Silverlight, and have spent thirteen years maintaining structural coherence through three major technology shifts."
faculty: ["design", "engineering", "uxia"]
thumbnail: /assets/img/Encore_devices.png
og_image: /assets/img/og-encore.png
...
description: "Thirteen years on one enterprise platform. I saw Silverlight was doomed, made the case for the browser, and have maintained structural coherence through three technology shifts. Design system, information architecture, AI adoption. The hard part isn't building something. It's keeping it coherent while everything around it changes."

...
The glyph system now classifies every artifact in this portfolio. [Savepoint Syntax](/governance/savepoint-syntax/) uses the same architecture. [Formwork Protocol](/governance/formwork-protocol/) applies the same principle to project governance.

...
permalink: /governance/prosthetic-cognition/
related:
...
In human-AI cognitive coupling, the interface layer consists of purpose-built tools that translate between how the human naturally thinks and how the model processes. These tools are described in the [accommodation design framework](/governance/accommodation-design/) (Salvato, 2026) and the [input inversion principle](/governance/input-inversion/) (Salvato, 2026). The relevant points for this paper:
...
- **[Formwork Protocol](/governance/formwork-protocol/)**: Decomposed evaluation with practitioner-extracted lenses
...
The production site [petersalvato.com](/) was compiled through the cognitive coupling described in this paper.
...
- Salvato, P. (2026). "Input Inversion: Why Unstructured Human Thinking Produces Better AI Output." [petersalvato.com/governance/input-inversion/](/governance/input-inversion/)

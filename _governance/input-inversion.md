...
permalink: /governance/input-inversion/
related:
...
Input inversion is one half of a bidirectional accommodation pattern described in the [accommodation design framework](/governance/accommodation-design/) (Salvato, 2026).

---
layout: context
title: "Somatic Design"
permalink: /vocabulary/somatic-design/
description: "Designing what the body registers before the mind names it. The layer between reading the room and building the framework. Physical landing before intellectual registration."
last_modified: 2026-03-15
icon: menu_book
seo_keywords:
  - somatic design
  - Peter Salvato
  - designing for physical response
  - why good design feels right
  - felt quality in design
  - invisible structure design
  - pacing as design material
  - sequencing UX
  - body response design
  - rhythm in design
  - why technically correct work feels dead
  - haptic design experience
  - design that works before you read it
  - physical landing experience design
  - attunement design
  - energy sequencing
  - how DJs read a room design
  - design engineering sensory layer
  - somatic response branding
  - pre-cognitive design
related:
  - /essays/somatic-design-what-the-body-feels/
  - /essays/the-charged-room/
  - /essays/where-i-learned-pacing/
  - /evidence/aiden-jae
  - /vocabulary/accommodation-design/
---
...
- **[Attunement](/vocabulary/attunement/)** — Reading the room before designing for it. Somatic design is what you build after the read. Attunement is the input; somatic design is the output.
- **[Accommodation Design](/vocabulary/accommodation-design/)** — Designing for how the system processes. Somatic design is accommodation design operating at the pre-cognitive layer: before the receiver names what they are experiencing.
- **[Fidelity](/vocabulary/fidelity/)** — The gap between what was meant and what survived. Somatic design fails when the sequence loses fidelity in translation from intent to execution.
- **[Load-bearing](/vocabulary/load-bearing/)** — The elements that carry structural weight without appearing to. In somatic design, most load-bearing elements are invisible to the receiver.
- **[Drift](/vocabulary/drift/)** — The accumulated loss of original intent. Somatic design is unusually vulnerable to drift because the structure that does the work is never visible. When it degrades, nobody can point to what changed.
- **[FormWork](/systems/formwork/)** — The coordination harness that holds all tools in position while the work is wet. FormWork is the structural layer; somatic design is what the receiver experiences when it works.

---

## Go Deeper

- [Somatic Design: What the Body Feels](/essays/somatic-design-what-the-body-feels/) — the half-degree rotation and why the structure has to be invisible
- [The Charged Room](/essays/the-charged-room/) — Twilo, ten hours on a dance floor, and the architecture underneath
- [Where I Learned Pacing](/essays/where-i-learned-pacing/) — how the dance floor principle transferred to a classroom and then to AI systems
- [Aiden Jae](/evidence/aiden-jae/) — a brand system where every touchpoint continues the same somatic sequence

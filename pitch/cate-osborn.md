...
layout: pitch
title: "For Cate"
subtitle: "Same pattern. Different infrastructure."
permalink: /pitch/cate-osborn/
sitemap: false
noindex: true
slug: cate
recipient_name: "Cate Osborn"
pw_hash: -1049703989
---
...
I built a [free series](/start/) that teaches exactly this. Four tools, each one a text file you paste into ChatGPT, Claude, or Gemini. Thirty seconds to set up. No code. No account. Your audience could be using them today.
...
<a class="essay-link" href="/essays/the-cook-who-falls-through-the-system/">
<strong>The Cook Who Falls Through the System</strong>
<span>The person running the accommodation is the one who needs it most. Kitchen story, but the pattern is universal.</span>
</a>
...
<strong>Why Does ChatGPT Get Worse the More You Type?</strong>
<span>The processing constraint nobody explains. And what to do about it.</span>
</a>

<a class="essay-link" href="/essays/compilation-not-generation/">
<strong>Compilation, Not Generation</strong>
<span>AI isn't writing for me. It's assembling what I already said into something I can publish.</span>
</a>

...
I spent three years proving that raw, unstructured thinking produces better AI output than careful prompts. Voice notes, unfinished sentences, arguments with myself. When purpose-built tools handle the translation, the mess produces better results than any prompt template. This paper documents why.
...
Finally, compound evaluation collapses when a model tries to assess multiple dimensions at once. **[LensArray](/systems/lensarray/)** separates them: independent dimensions, each assessed against its own criteria by a lens extracted from a real practitioner's body of work. One dimension per pass.
...
**Source:** [GitHub](https://github.com/PeterSalvato/input-inversion)

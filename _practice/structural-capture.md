---
layout: project
title: "Structural Capture"
subtitle: "The tool can't tell a breakthrough from a typo fix."
permalink: /practice/structural-capture/
description: "Ideas don't survive between AI sessions. The context that connected your thinking disappears when the window closes. Structural capture marks when your thinking turns so the continuity is yours."
seo_keywords: ["structural capture", "SavePoint", "AI context loss", "AI session continuity", "idea capture AI", "creative AI workflow", "Peter Salvato"]
published: true
related:
  - /systems/savepoint
  - /work/new-city
...
The worst loss was a novel. Months of ideation distributed across dozens of AI sessions, the continuity severed when the sessions closed. The characters, the structure, the connections between scenes. All of it existed in the conversation and none of it survived.
...
[SavePoint](/systems/savepoint/) is the protocol. Version 3.2. Timestamped, categorized, searchable across conversation exports.

## Evidence

This site is structural capture of three years of thinking. 6,000+ conversations compiled into what you're reading.

## The Origin

[New City](/work/new-city/): the novel lost between sessions. The loss that built SavePoint.

## Related Essays

- [I Needed a Better Tool](/essays/i-needed-a-better-tool/)

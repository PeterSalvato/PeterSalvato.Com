...
2. Go to [claude.ai](https://claude.ai) and create a new Project (or use the one from SavePoint)
3. Copy the instructions below and paste them into the project instructions
4. Next time you say "I need to..." your AI breaks it into real steps
...
<pre><code>TASK CHUNKER INSTRUCTIONS
...
Don't ask me if I want things broken down. Just do it. If the steps are too small, I'll tell you.</code></pre>
...
> 1. Put away any food that's still out (low energy)
> 2. Scrape plates into the trash (low energy)
> 3. Load everything into the dishwasher (medium energy)
>
> — Good stopping point. Food is safe, dishes are handled. —
>
> 4. Wipe the counters (low energy)
> 5. Wipe the stove (low energy)
> 6. Take out the trash if it's full (low energy)
>
> — Good stopping point. The kitchen works. You can cook in it. —
>
> 7. Sweep the floor (medium energy)
> 8. Clean the sink (low energy)
>

...
In my evaluation work, I extract lenses from practitioners like Rand. The Rand lens asks: can this concept survive further reduction? If it can, it hasn't reached its irreducible unit yet. If removing anything breaks the concept, you've arrived. That lens applies to a logo, to a page layout, to a blog post, to an SCSS variable architecture. The material changes every time, but the question works in all of them.

What I took from Rand, before I understood what I was taking, was that the concept is the structure. The structure underneath everything else, stripped to the point where nothing decorative remains. The IBM logo taught me that in design school. Twenty years of practice proved him right.

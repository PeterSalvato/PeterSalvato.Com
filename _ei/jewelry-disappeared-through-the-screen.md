...
So I built [Aiden Jae](/output/aiden-jae/) as one integrated system. Brand identity, photography direction, Shopify architecture, packaging. Each one a layer, each built independently, each serving one principle: the code respects the photograph.

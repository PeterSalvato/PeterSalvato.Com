---
layout: post
title: "The Formwork Lenses as AI Governance"
date: 2026-03-09
published: true
description: "Design history as the evaluative rigor that prevents AI drift."
seo_keywords: ['ai', 'governance', 'convergence', 'the selector', 'Peter Salvato', 'design engineering']
...
The [Formwork Protocol](/governance/formwork-protocol/) prevents this drift the same way it prevents drift in any creative evaluation: by testing output against specific, codified criteria extracted from real practitioners. The lenses are the governance layer. Design history provides the rigor.

...
[Altrueism](/output/altrueism/) had the same problem from a different angle. The client made handcrafted objects with sustainable ethics. The first round of brand explorations went where most go first: script fonts, cursive motion, expressive warmth. It looked right. It matched the category.

...
seo_keywords: ["construction management", "general contractor", "decomposition", "systems thinking", "methodology limits", "design engineering"]
...
My father could hold the live state of an entire building in his head. Which trades were where, what was poured, what was curing, what couldn't start until Thursday because the glaziers were two days behind on the curtain wall. Fifty trades on a skyscraper site, each one working their piece, and he held the picture of how all those pieces fit together at any given moment.

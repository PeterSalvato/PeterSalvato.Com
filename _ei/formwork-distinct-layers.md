...
The [Formwork Protocol](/governance/formwork-protocol/) rebuilds that room as a system. Distinct layers of concern, each staffed with evaluative personas extracted from real practitioners, run independently and read together. The layers are the plates. The personas are the trades. The maker is the general contractor.

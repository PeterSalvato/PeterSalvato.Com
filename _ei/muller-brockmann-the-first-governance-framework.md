---
layout: post
title: "Müller-Brockmann: The First Governance Framework"
date: 2026-03-30
published: true
description: "The grid is governance: structure that creates order from complexity."
seo_keywords: ['Müller-Brockmann', 'grid', 'governance', 'design history', 'Peter Salvato', 'design engineering']
series: "engineering-intent"
zone: 4
sequence: 115
depth: reading
domain: Design history + Operational methodology
function: Payload
seed_status: DEEP
last_modified: 2026-03-30
---

Josef Müller-Brockmann published "Grid Systems in Graphic Design" in 1981. The book presents the grid as an organizational tool for visual communication. Columns, rows, baseline grids, margins. The system creates consistent spatial relationships across every page in a publication.

Most designers learn the grid as a layout technique. Put things on the grid. Align elements to the columns. Use the baseline for vertical rhythm. These are useful instructions. They miss the point.
...
Müller-Brockmann was building governance frameworks in 1961, decades before anyone used that language. The vocabulary was different, but the operation is the same. Create structure that makes consistent decisions so the human can focus on the decisions that require human judgment.

Every governance system I've built traces a line back to the grid. It was the first time I saw structure replace judgment as the primary organizing principle, and everything since then has been the same idea applied to different materials.

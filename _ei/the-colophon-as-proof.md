---
layout: post
title: "The Colophon as Proof"
date: 2026-03-19
published: true
description: "A colophon traditionally lists the tools and methods used to produce a book. This site's colophon is the methodology itself, because the site was built with the methodology it describes."
seo_keywords: ["colophon", "self-documenting", "methodology", "proof of work", "Peter Salvato", "design engineering", "FormWork", "portfolio architecture", "meta-design"]
...
Here's the thing about this particular colophon: it already exists on the site. The [FormWork](/systems/formwork/) page describes the coordination harness. The [voice governance](/essays/voice-governance/) essay explains how the voice protocol works. [Lens extraction](/essays/persona-extraction/) covers the evaluation framework. [SavePoint](/systems/savepoint/) documents the protocol that captures cognitive turns during the work itself.

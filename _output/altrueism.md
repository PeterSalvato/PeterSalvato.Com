...
That same discovery informed [Aiden-Jae](/output/aiden-jae/), another craft brand where the generic visual vocabulary would have flattened the real character of the work. The diagnostic question is always the same: what does the brand need to prove, and is the visual system proving it?

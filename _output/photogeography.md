...
If you can't crop, you reposition. If you can't change the ratio, you learn to see in the shape the format demands. Fewer options means you actually have to see what's in front of you. This started as an experiment inside [Meditations](/output/meditations/) and grew into its own system once the archive got serious enough to need one.

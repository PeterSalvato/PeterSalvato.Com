...
seo_keywords: ['three layer model', 'Peter Salvato', 'design engineering', 'why one size fits all solutions fail', 'personalization vs customization design', 'designing for individual needs at scale', 'accommodation at the individual level', 'systems that actually work for everyone', 'accommodation design', 'cooking for family with different diets', 'meal planning multiple food restrictions', 'systems that scale to individual needs']
series: "engineering-intent"
chapter: 11
order: 7
icon: edit_note
permalink: /essays/the-three-layers/
---
...
The pattern was always there. I've always operated this way, long before I could describe it. I put ASCII art in code comments because I experience the code visually and I need the file to accommodate that. I built branded kitchen systems (mise en place stations, labeled containers, a whole batch-and-assembly workflow) because I experience the kitchen as a designed environment and four people with different needs eat there every night. The layers were already there in every room I worked in. I just didn't have a way to point at them.

What changed was the naming. Once the pattern had a name, I could point at it. I could say to a client: your product has a strong group body and decent persona logic, but the individual accommodation layer is missing entirely. I could say to myself: this DJ set has great individual reads but the persona is incoherent, I am jumping between grammars. The naming made the pattern communicable. It turned something I did by instinct into something I could teach, diagnose, and design with. And that's been the real shift for me. Not learning the pattern, because the pattern was already running. Figuring out how to hand it to someone else.

...
order: 14
icon: edit_note
permalink: /essays/construction-sites-where-does-this-fail/
---
...
Without that picture, the building doesn't go up straight.
...
A tradesman carries his own tools, calibrated to his hand. That's a point of pride, and it's also the problem.
...
That's strength and fragility at the same time. What happens when I'm not in the room? The same thing that happened on the construction site. The picture walks out with me.
...
The methodology I use now, the decomposition, the separation of concerns, the insistence on making structure visible, all of it comes from watching this failure up close. On construction sites first, and then in my own work when I finally admitted I was doing the same thing.

I built [FormWork](/systems/formwork/) because I needed a coordination harness that wasn't me. I built [SavePoint](/systems/savepoint/) because context kept leaving when I left. They're patches on a failure I kept repeating.

The question I keep asking is where does this fail. I got that from the job sites, from watching fifty trades work their piece and knowing that the building doesn't care how good any single trade is if the joints don't register. But the harder version of that question points inward, and I avoided it for a long time. Where does this fail when the failure is you? When you're the single point of failure and you're also the person who built the methodology?

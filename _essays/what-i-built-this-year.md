...
seo_keywords: ["design engineering", "design methodology", "AI governance", "creative evaluation framework", "operational methodology", "Peter Salvato", "Formwork Protocol"]
---
...
The methodology behind all of this is documented on the [Formwork Protocol](/governance/formwork-protocol/) page. None of it started with AI. The design practice is twenty-five years old. The operational methodology comes from construction sites, print shops, enterprise platforms, and classrooms. AI is the current material.

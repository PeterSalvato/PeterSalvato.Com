...
related:
  ...
  - /evidence/encore
  - /practice/this-site
permalink: /essays/how-i-got-here/
---
...
I grew up on those sites. Before I knew anything about design or code or information architecture, I understood something about structure: you can always tell when it's right, and the difference is usually in the joints and the planning.
...
Screenprinting is where the way I think locked in. Separation means you never work on the image. You work on a channel, one color at a time, pulling a whole apart into layers that reconstruct it when they register. You're making decisions about how colors interact when they overprint (opacity, trapping, bleed) and none of that is visible yet. The whole composition exists only in your head while you're building a single screen.

...
I've spent my career building systems that hold structure when the people operating them run out of capacity. An enterprise platform that kept running while I rebuilt the layer it sat on. A protocol that preserves context when the AI loses the thread. A framework that maintains evaluation criteria when the team forgets what was already decided.

The kitchen is the room where that work comes home. The constraints are medical and neurological, not technical. The stakes are whether my kids eat. The methodology is the same. Read the people in the system. Document their profiles. Build structure that accommodates without requiring anyone to explain what they need. Make the environment carry what working memory drops.
